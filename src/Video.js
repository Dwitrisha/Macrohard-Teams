		...
		return (
			<div id="video_page">
				...
				{this.state.askForUsername === true ?
					<div className="video_div">
						<div style={{ width: "30%", height: "auto", padding: "20px", minWidth: "400px",
								textAlign: "center", margin: "auto", marginTop: "50px", justifyContent: "center"}}>
									<PersonPinIcon style={{fontSize:70}}/>
							<p id="call_heading">Set your username</p>
							<Input placeholder="Username" value={this.state.username} onChange={e => this.handleUsername(e)} />
							<Button id="video_button" onClick={this.connect}>Connect</Button>
						</div>
					
						<div  style={{ justifyContent: "center", textAlign: "center", paddingTop: "5px" }}>
							<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
								borderStyle: "solid",borderColor: "#bdbdbd",objectFit: "fill",height: "40vh", borderRadius: "25px"}}>
					...
					<div className="container" style={{marginLeft:"13vh", width:"93vw"}}>
							<div style={{ paddingTop: "9vh" }}>
								<Input value={window.location.href} disable="true"></Input>
								<Button id="connect_button" onClick={this.copyUrl}>Copy invite link</Button>
							</div>
